            ...
            @foreach ($users as $user)
                <tr>
                    ...
                    <td class="align-middle text-center text-sm">
                        ...
                        <div class="address-item"><strong>Phường:</strong> {{ $user->district_id }}</div>
                        <div class="address-item"><strong>Quận:</strong> {{ $user->ward_id }}</div>
                        <div class="address-item"><strong>Thành Phố:</strong> {{ $user->province_id }}</div>
                    </td>
