...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => Config::get('apps.user.create.title')])
    <input type="hidden" id="getLocationUrl" value="{{ route('ajax.location.index') }}">
                        ...
                        <div class="row justify-content-between text-left">
                            ...
                            <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Nhóm
                                    thành viên<span class="text-danger">
                                        (*)</span></label>
                                <select value="{{ old('user_catalogue_id') }}" class="setupSelect2" name="user_catalogue_id"
                    ...
                    <div class="card p-4">
                        <div class="row justify-content-between text-left">
                            <div class="form-group col-sm-6 flex-column d-flex"> <label
                                    class="form-control-label px-3">Thành Phố</label>
                            ...
                            <div class="form-group col-sm-6 flex-column d-flex"> <label
                                    class="form-control-label px-3">Quận/ Huyện</label>
