...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => Config::get('apps.user.index.title')])
                ...
                <div class="card mb-4">
                    <div class="d-flex justify-content-between">
                        <div class="card-header pb-0">
                            <h6>{{ Config::get('apps.user.index.table') }}</h6>
                        </div>
                        <div class="card-header pb-0">
                            <a class="btn btn-primary my-auto mr-4" href="{{ route('user.create') }}">Thêm mới thành viên</a>
                        </div>
                    </div>
